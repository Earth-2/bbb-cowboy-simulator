...
MAIN_HEIGHT     = 70    ;192 - 3 = 189 - 5 = 184 - 8 = 176 - 8 = 168
...
Title:      .SUBROUTINE
            ...
            ;LDA #$16               ; ugly ass buff color I had used
...
.Line:      STA WSYNC
            ...
            LDA #%00000110  ;3 Bs
            STA NUSIZ0
            LDY #5          ; gap between graphic and Bs
            NOP
.delay:     DEY
            BNE .delay
            STA RESP0
...
DIGHEIGHT   = 5*8
ENDBRDSIZE  = ((192-DIGHEIGHT)/2)-1

Endscreen:   .SUBROUTINE

            LDA #$56            ;set the background color 
            STA COLUBK
