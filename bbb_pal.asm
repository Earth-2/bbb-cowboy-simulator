...
FPS             = 50            ;frames per second (used in calculating game
                                ; timer). On a PAL television, this will ALWAYS
                                ; be equal to 50
...
JUMP_ARC        = 18            ;total distance of standard jump arc
...
LIVES_COL       = $2C           ;lives counter
DOOM_COL        = $28           ;Doom Meter
...
MtnCol1     .BYTE $45       ;FLASHES

BakCol1     .BYTE $63       ;FLASHES
